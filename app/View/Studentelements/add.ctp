<div class="studentelements add">
  <!-- PROCESSOR DETAILS PANEL -->
  <div class="row">
    <div class="col-md-12 mb-3">
      <div class="card-header bg-primary text-white">
        <div class="card-title">
          <h3><i class="fas fa-plus"></i>&nbsp;&nbsp;Add Student Data Element</h3>
        </div>
      </div>
			<?php echo $this->Form->create('Studentelement', array('role' => 'form', 'class' => 'inline-form')); ?>
      <ul class="list-group">
        ...
        <li id="editview" class="list-group-item card-list-item border-primary">
            <div class="row col-12">  
              ...
              <?php
              echo $this->Form->checkbox('sensitvedata', array(
                'id' => 'addstudentdata',
              ))
              ;?>
              <label for="addstudentdata">
          ...
          <li class="card-title bg-info text-white list-group-item border-primary">
            <h4><i class="fas fa-exchange-alt"></i>&nbsp;&nbsp;Software &amp; Systems Sharing</h4>
          </li>
          <li id="editview" class="list-group-item card-list-item border-primary">
            <?php 
