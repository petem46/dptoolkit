<div class="parentelementsProcessors index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Parentelements Processors'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Parentelements Processor'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('parentelement_id'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($parentelementsProcessors as $parentelementsProcessor): ?>
					<tr>
								<td>
			...
			<?php echo $this->Html->link($parentelementsProcessor['Parentelement']['name'], array('controller' => 'parentelements', 'action' => 'view', $parentelementsProcessor['Parentelement']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $parentelementsProcessor['ParentelementsProcessor']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $parentelementsProcessor['ParentelementsProcessor']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $parentelementsProcessor['ParentelementsProcessor']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $parentelementsProcessor['ParentelementsProcessor']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
