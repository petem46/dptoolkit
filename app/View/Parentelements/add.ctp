<div class="parentelements add">
  <!-- PROCESSOR DETAILS PANEL -->
  <div class="row">
    <div class="col-md-12 mb-3">
      <div class="card-header bg-primary text-white">
        <div class="card-title">
          <h3><i class="fas fa-plus"></i>&nbsp;&nbsp;Add Parent Data Element</h3>
        </div>
      </div>
      <?php echo $this->Form->create('Parentelement', array('role' => 'form', 'class' => 'inline-form')); ?>
      <ul class="list-group">
