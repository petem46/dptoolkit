<div class="parentelements view">
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Parentelement'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Parentelement'), array('action' => 'edit', $parentelement['Parentelement']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Parentelement'), array('action' => 'delete', $parentelement['Parentelement']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $parentelement['Parentelement']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Parentelements'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Parentelement'), array('action' => 'add'), array('escape' => false)); ?> </li>
		...
		<td>
			<?php echo h($parentelement['Parentelement']['id']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($parentelement['Parentelement']['name']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($parentelement['Parentelement']['sensitivedata']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
...
<div class="related row">
	...
	<?php if (!empty($parentelement['Processor'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($parentelement['Processor'] as $processor): ?>
		<tr>
