<div class="dataaccessgroups view">
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Dataaccessgroup'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Dataaccessgroup'), array('action' => 'edit', $dataaccessgroup['Dataaccessgroup']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Dataaccessgroup'), array('action' => 'delete', $dataaccessgroup['Dataaccessgroup']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $dataaccessgroup['Dataaccessgroup']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Dataaccessgroups'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Dataaccessgroup'), array('action' => 'add'), array('escape' => false)); ?> </li>
		...
		<td>
			<?php echo h($dataaccessgroup['Dataaccessgroup']['id']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($dataaccessgroup['Dataaccessgroup']['name']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
...
<div class="related row">
	...
	<?php if (!empty($dataaccessgroup['Processor'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($dataaccessgroup['Processor'] as $processor): ?>
		<tr>
