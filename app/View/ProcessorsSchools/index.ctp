<div class="processorsSchools index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Processors Schools'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Processors School'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($processorsSchools as $processorsSchool): ?>
					<tr>
								<td>
			...
			<?php echo $this->Html->link($processorsSchool['School']['name'], array('controller' => 'schools', 'action' => 'view', $processorsSchool['School']['id'])); ?>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $processorsSchool['ProcessorsSchool']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $processorsSchool['ProcessorsSchool']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $processorsSchool['ProcessorsSchool']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $processorsSchool['ProcessorsSchool']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
