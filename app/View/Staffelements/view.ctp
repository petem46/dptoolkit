<div class="staffelements view">
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Staffelement'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Staffelement'), array('action' => 'edit', $staffelement['Staffelement']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Staffelement'), array('action' => 'delete', $staffelement['Staffelement']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $staffelement['Staffelement']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Staffelements'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Staffelement'), array('action' => 'add'), array('escape' => false)); ?> </li>
		...
		<td>
			<?php echo h($staffelement['Staffelement']['id']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($staffelement['Staffelement']['name']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($staffelement['Staffelement']['sensitivedata']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
...
<div class="related row">
	...
	<?php if (!empty($staffelement['Processor'])): ?>
	<table cellpadding = "0" cellspacing = "0" class="table table-striped">
	<thead>
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<thead>
	<tbody>
	<?php foreach ($staffelement['Processor'] as $processor): ?>
		<tr>
