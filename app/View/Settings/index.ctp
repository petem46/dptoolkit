			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('processorslabel'); ?></th>
						<th><?php echo $this->Paginator->sort('supplierslabel'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($settings as $setting): ?>
					<tr>
						...
						<td><?php echo h($setting['Setting']['sitename']); ?>&nbsp;</td>
						<td><?php echo h($setting['Setting']['processorslabel']); ?>&nbsp;</td>
						<td><?php echo h($setting['Setting']['supplierslabel']); ?>&nbsp;</td>
						<td class="actions">
