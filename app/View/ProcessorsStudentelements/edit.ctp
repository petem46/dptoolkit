	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Edit Processors Studentelement'); ?></h1>
			</div>
		</div>
	</div>
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="">
																...
																<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete'), array('action' => 'delete', $this->Form->value('ProcessorsStudentelement.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('ProcessorsStudentelement.id'))); ?></li>
